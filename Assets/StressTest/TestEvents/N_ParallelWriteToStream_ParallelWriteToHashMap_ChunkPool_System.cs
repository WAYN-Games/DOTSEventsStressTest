...
public partial class N_ParallelWriteToStream_ParallelWriteToHashMap_ChunkPool_System : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (SystemAPI.GetSingleton<EventStressTest>().EventType != EventType.N_ParallelWriteToStream_ParallelWriteToHashMap_ChunkPool)
            return;
